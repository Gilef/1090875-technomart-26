...
function open_letter_popup(event) {
    ...
    letter_popup.classList.add("form-bounse");
...
var buy_popup_skip_button = document.querySelector(".catalog-button-skip");
...
if (buy_popup_open_button && buy_popup_close_button) {
    ...
    buy_popup_skip_button.addEventListener("click", close_buy_popup);
